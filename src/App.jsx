...
function App() {
  ...
  return (
    <div>
      ...
      {lowestKi >= 0 && <Card dataType="Lowest Power Level" data={lowestKi} />}

      {highestKi >= 0 && (
        <Card dataType="Highest Power Level" data={highestKi} />
      )}

      {averageKi >= 0 && (
        <Card dataType="Average Power Level" data={averageKi} />
      )}
